...
class AssetsHook extends AbstractHook
{
    ...
    /** @var string */
    protected $scriptUrl = 'https://public-assets.tagconcierge.com/consent-banner/1.2.1/cb.min.js';

    /** @var string */
    protected $styleUrl = 'https://public-assets.tagconcierge.com/consent-banner/1.2.1/styles/light.css';
